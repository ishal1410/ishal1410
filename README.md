...
<p align="center">
  <a href="https://www.linkedin.com/in/vishal1410"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn"></a>
  <a href="mailto:vp1412003@gmail.com"><img src="https://img.shields.io/badge/vp1412003@gmail.com-EA4335?style=flat-square&logo=gmail&logoColor=white" alt="Email"></a>
</p>
...
`Next.js` `TypeScript` `SerpApi google_lens` `Vercel Blob` `177 tests`
...
`JavaScript` `Node.js` `CI` · 9 stars · zero dependencies
...
Machine learning: PyTorch, TensorFlow, scikit-learn, OpenCV, EfficientNet, LSTM, Strands Agents
