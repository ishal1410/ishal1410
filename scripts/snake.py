#!/usr/bin/env python3
# Vendored from https://github.com/dahan8473/snake-and-commits (MIT).
# Copyright (c) 2026 David Liu. Full licence: that repository's LICENSE.
#
# Vendored rather than used as a third-party GitHub Action so that no outside
# Action holds contents:write on this repository. It is stdlib-only, so there
# is nothing to install; it reads the public contribution calendar over the
# GraphQL API and writes one SVG.
